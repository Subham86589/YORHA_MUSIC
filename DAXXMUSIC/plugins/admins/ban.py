...
async def ban_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "ʙᴀɴ ʀɪɢʜᴛs ɴʜɪ ᴅɪʏᴇ? Kʜᴜᴅ ᴋᴏ sᴜʙʙᴜ Jᴇsᴀ ᴘᴏᴡᴇʀғᴜʟ sᴏᴄʜᴛᴇ ʜᴏ..?😂 🙌\nGive me ban rights! 😡🥺"
        return msg_text, False
    except UserAdminInvalid:
        msg_text = "I wont ban an admin bruh!!You are not Subbu"
        return msg_text, False
    except Exception as e:
        if user_id == 6711389550:
            msg_text = "why should i ban myself? sorry but I'm not stupid like you Now beg to Subbu"
            return msg_text, False
...
async def mute_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "ᴍᴜᴛᴇ ʀɪɢʜᴛs ɴʜɪ ᴅɪʏᴇ? Kʜᴜᴅ ᴋᴏ sᴜʙʙᴜ Jᴇsᴀ ᴘᴏᴡᴇʀғᴜʟ sᴏᴄʜᴛᴇ ʜᴏ..?😂 🙌\nGive me mute rights! 😡🥺"
        return msg_text, False
    except UserAdminInvalid:
        msg_text = "I wont mute an admin bruh!!You are not Subbu"
        return msg_text, False
    except Exception as e:
        if user_id == 7427691214:
            msg_text = "why should i mute myself? sorry but I'm not stupid like you Now beg to Subbu"
            return msg_text, False
